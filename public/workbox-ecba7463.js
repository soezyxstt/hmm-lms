define(["exports"], function (t) {
  ...
  const r = (t) => (t && "object" == typeof t ? t : { handle: t });
  class n {
    constructor(t, e, s = "GET") {
      ((this.handler = r(e)), (this.match = t), (this.method = s));
    }
    setCatchHandler(t) {
      this.catchHandler = r(t);
    }
  }
  class i extends n {
    constructor(t, e, s) {
  ...
  class m {
    ...
    async fetch(t) {
      ...
      try {
        for (const t of this.iterateCallbacks("requestWillFetch"))
          r = await t({ request: r.clone(), event: e });
      } catch (t) {
    ...
    async cacheMatch(t) {
      ...
      const { cacheName: r, matchOptions: n } = this.u,
        ...
        o = Object.assign(Object.assign({}, n), { cacheName: r });
    ...
    async cachePut(t, e) {
      ...
      var i;
      const o = await this.q(e);
      if (!o) return !1;
      const { cacheName: a, matchOptions: c } = this.u,
        u = await self.caches.open(a),
        f = this.hasCallback("cacheDidUpdate"),
        l = f
          ? await (async function (t, e, s, r) {
              const n = w(e.url, s);
              if (e.url === n) return t.match(e, r);
              const i = Object.assign(Object.assign({}, r), {
                  ignoreSearch: !0,
                }),
                o = await t.keys(e, i);
              for (const e of o) if (n === w(e.url, s)) return t.match(e, r);
            })(u, n.clone(), ["__WB_REVISION__"], c)
          : null;
      try {
        await u.put(n, f ? o.clone() : o);
      } catch (t) {
        if (t instanceof Error)
          throw (
  ...
  class v {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        n = new m(this, { event: e, request: s, params: r }),
        i = this.R(n, s, e);
      return [i, this.O(i, n, s, e)];
    }
    async R(t, e, r) {
      let n;
      await t.runCallbacks("handlerWillStart", { event: r, request: e });
      try {
        if (((n = await this.C(e, t)), !n || "error" === n.type))
          throw new s("no-response", { url: e.url });
      } catch (s) {
        if (s instanceof Error)
          for (const i of t.iterateCallbacks("handlerDidError"))
            if (((n = await i({ error: s, event: r, request: e })), n)) break;
        if (!n) throw s;
      }
      for (const s of t.iterateCallbacks("handlerWillRespond"))
        n = await s({ event: r, request: e, response: n });
      return n;
    }
    async O(t, e, s, r) {
      let n, i;
  ...
  ((t.NetworkOnly = class extends v {
    constructor(t = {}) {
      (super(t), (this._ = t.networkTimeoutSeconds || 0));
    }
    async C(t, e) {
      let r, n;
      try {
        const s = [e.fetch(t)];
        if (this._) {
          const t = h(1e3 * this._);
          s.push(t);
        }
        if (((n = await Promise.race(s)), !n))
          throw new Error(
            `Timed out the network response after ${this._} seconds.`,
          );
      } catch (t) {
        t instanceof Error && (r = t);
      }
      if (!n) throw new s("no-response", { url: t.url, error: r });
      return n;
    }
  }),
    ...
    (t.registerRoute = function (t, e, r) {
      let o;
      if ("string" == typeof t) {
        const s = new URL(t, location.href);
        o = new n(({ url: t }) => t.href === s.href, e, r);
      } else if (t instanceof RegExp) o = new i(t, e, r);
      else if ("function" == typeof t) o = new n(t, e, r);
      else {
        if (!(t instanceof n))
