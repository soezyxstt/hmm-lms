...
function SidebarProvider({
  ...
  // Close mobile sidebar only when a route transition has completed.
  React.useEffect(() => {
    const hasNavigated = previousPathnameRef.current !== pathname;
    if (isMobile && openMobile && hasNavigated) {
      setOpenMobile(false);
    }
...
function SidebarMenuSkeleton({
  ...
  // Stable width for loading skeletons (avoids impure render).
  const width = "70%";
